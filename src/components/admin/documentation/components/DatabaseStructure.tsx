...
export function DatabaseStructure() {
  ...
  const validateTypes = (table: TableInfo) => {
    ...
    if (table.fields) {
      table.fields.forEach(field => {
        ...
        validations.push({
          ...
          dbType: fieldType,
          tsType: tsType,
          isValid: isValidTypeMapping(fieldType, tsType),
          message: getValidationMessage(fieldType, tsType)
        })
      })
    }
              ...
              filteredTables.map((table) => (
                <div key={table.name} className="space-y-4">
                  ...
                  <TypeValidation 
                    ...
                    validations={validateTypes(table)}
                  />
                </div>
              ))
            ) : (
